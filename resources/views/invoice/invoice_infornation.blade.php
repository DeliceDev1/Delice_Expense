                ...
                <div class="container-fluid">
                    <div class="mb-2">
                        <div class="col-lg-8 mx-auto bg-gray-100 shadow-md rounded py-3">
                            ...
                            @endif
                            <form action="{{ route('store.invoice', $branch_id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div>
                                    <p
                                        class="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% text-white rounded-lg py-2.5 text-center m-3">
                                        INVOICE DATA
                                    </p>
                                    <div class="grid grid-cols-1 gap-4">
                                        <div class="px-4 py-2">

                                            <p class="text-purple-800 font-bold">Invoice from:</p>
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <textarea name="sender_address" id="sender_address" cols="30" rows="2"
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="sender_country" id="sender_country"
                                                    class="block w-full p-2 text-gray-900 border border-gray-300 rounded-xl bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            </div>
                                            <div>
